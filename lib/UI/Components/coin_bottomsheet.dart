      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Text("Your Coins", style: TextStyle(color: Colors.white, fontSize: 16.sp)),
              Text("$userCoins", style: TextStyle(color: Colors.yellow, fontSize: 16.sp)),
            ],
          ),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text("Required Coins", style: TextStyle(color: Colors.white, fontSize: 16.sp)),
              Text("$requiredCoins", style: TextStyle(color: Colors.redAccent, fontSize: 16.sp)),
            ],
          ),
      ...
      actions: [
        ...
        ElevatedButton(
          onPressed: () async {
            ...
            print("🧾 DEBUG => contentId: $contentId, contentType: $contentType, slug: $slug, price: $price");

            await _callCoinPurchaseApi(contentId: contentId, contentType: contentType.toString(),slug: slug,price: price);
          },
...
Future<void> _callCoinPurchaseApi({
  ...
  try {
    ...
    if (success) {
      ...
      controller.fetchMovieDetails(slug);
